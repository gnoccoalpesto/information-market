...
class Agent:
    ...
    def record_transaction(self,type:str,seller_id:int=None,transaction:Transaction=None,variable_stake:bool=False,reputation_method:str='h'):
        if type=="attempted" or type=="a" or type=="A" or \
            ...
            self.environment.payment_database.record_transaction(type,self.id,seller_id,transaction,variable_stake,reputation_method)
        else:
